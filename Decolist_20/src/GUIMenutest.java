...
//    public GUIMenutest(LinkedList<Task> task, JTable Jtable, DefaultTableModel DFJtable, Middle_Controll midControll) {
...
//        toppanel = new TopPanel(task, Jtable, DFJtable, midControll);
//        
