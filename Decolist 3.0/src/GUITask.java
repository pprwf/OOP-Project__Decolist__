...
public class GUITask extends JPanel implements Runnable{
    ...
    public GUITask(int number, String name, String des, String time, String exp) {
        ...
        taskName = new ThaiFont().thBoldItalic.deriveFont(33f);
        taskDes = new ThaiFont().thBold.deriveFont(20f);
        ...
        this.setBackground(MiddleView.BG_COLOR);
        ...
        labelTime.setFont(new Font("serif", Font.BOLD, 20));
        labelDate.setFont(new Font("serif", Font.PLAIN, 10));
        labelName.setFont(taskName);
        labelDes.setFont(taskDes);
        ...
        lDonenew.setFont(new Font("serif", Font.BOLD, 20));
