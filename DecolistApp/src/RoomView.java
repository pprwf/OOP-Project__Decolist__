...
public class RoomView {
    ...
    public RoomView(JPanel panel){
        ...
        panelFurniture.setBackground(new Color(240, 255, 255));
...
//        panelFurniture.add(panelFurniture_in2, BorderLayout.CENTER);
        ...
        panelFurniture_in1.setBackground(new Color(247, 255, 255));
        panelFurniture_in2.setBackground(new Color(240, 255, 255));
